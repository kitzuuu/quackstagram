...
public class UploadButton implements INavigationButton {
    private static final String ICON_PATH = "src/main/resources/navigationpanelsingleton/buttons/UploadButton.png";
